...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildConfiguration.git_last_revision'
        db.add_column(u'webui_buildconfiguration', 'git_last_revision',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildConfiguration.git_last_revision'
        db.delete_column(u'webui_buildconfiguration', 'git_last_revision')
    ...
    models = {
        ...
        u'webui.buildconfiguration': {
            ...
            'git_last_revision': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
